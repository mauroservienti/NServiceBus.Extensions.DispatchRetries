...
namespace NServiceBus
{
    ...
    class AcceptanceTestTransportInfrastructure : TransportInfrastructure
    {
        ...
        {
            return new TransportReceiveInfrastructure(() => new AcceptanceTestTransportMessagePump(storagePath), () => new AcceptanceTestTransportQueueCreator(), () => Task.FromResult(StartupCheckResult.Success));
        }
        ...
        public override TransportSendInfrastructure ConfigureSendInfrastructure()
        {
            ...
            var failDispatchOnce = settings.GetOrDefault<bool>(FailDispatchOnceKey);
            return new TransportSendInfrastructure(() => new AcceptanceTestTransportDispatcher(storagePath, maxPayloadSize, failDispatchOnce), () => Task.FromResult(StartupCheckResult.Success));
        }
        ...
        public override TransportSubscriptionInfrastructure ConfigureSubscriptionInfrastructure()
        {
            return new TransportSubscriptionInfrastructure(() =>
            {
                ...
                return new AcceptanceTestTransportSubscriptionManager(storagePath, endpointName, localAddress);
            });
        }
        ...
        const string DefaultLearningTransportDirectory = ".acceptancetesttransport";
        public const string StorageLocationKey = "AcceptanceTestTransport.StoragePath";
        public const string NoPayloadSizeRestrictionKey = "AcceptanceTestTransport.NoPayloadSizeRestrictionKey";
        public const string FailDispatchOnceKey = "AcceptanceTestTransport.FailDispatchOnceKey";
    }
}
